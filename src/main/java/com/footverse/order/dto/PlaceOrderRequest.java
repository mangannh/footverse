 ...
 *
 * @param cartItemIds   the selected cart item ids to purchase; required, non-empty, each positive
 *                      and unique (a duplicate id is rejected as {@code 400 VALIDATION_ERROR},
 ...
 * @param paymentMethod optional payment method (validation-spec §10, Sprint 13 Task 08); no
 *                      {@code @NotNull} and no DTO-level default — an absent value resolves to
 *                      {@code COD} in {@code OrderServiceImpl} (Design Decision 8), preserving
