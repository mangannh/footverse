...
/**
 * Admin payload for {@code POST /coupons} (validation-spec §12). Code uniqueness and the
 * {@code endAt} after {@code startAt} window are business rules enforced by the service, not
