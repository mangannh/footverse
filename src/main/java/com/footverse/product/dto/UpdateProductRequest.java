...
/**
 * Admin request to update a product (validation-spec §12). Category / brand existence is
 * re-validated in the service only when the request changes those associations; the base price
 * must be positive.
 *
